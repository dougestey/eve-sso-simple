...
module.exports = {
  ...
  */
  getTokens: function (setup, req, res, callback, error) {
    ...
    return new Promise((resolve, reject) => {
      ...
      if (req.query.code) {
        ...
        } else if (req.cookies.access_token || req.cookies.character_token) {

          if (callback) callback(accessToken, charToken);
